...
#'   \item{val_numeric_orig}{The original numeric value}
#'   \item{val_order_alpha}{Sorted order of the value label}
#'   \item{val_order_length}{Total number of value labels of the variable}
