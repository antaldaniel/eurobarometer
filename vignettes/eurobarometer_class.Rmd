...
These attributes can be converted to labelled_spss with the haven::labelled_spss constructor. However, we are adding several further attributes, which do not interfere with the functionalilty of the labelled class, but document all the history of the harmonization.
