...
The trust_vector contains the harmonized numeric values, harmonized labels alongside the original values and the original labels. This means that all conversion is _reversible_.
...
We create a generic function  `document_qb` that orders the variable renaming, value label harmonization, class conversions steps into a neat table. 
