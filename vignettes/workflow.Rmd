...
* a truly unique id
* id elements for joining in individual survey data, in this example, * The two most basic weight vars, `w1` and `wex`, because I would not leave the pain of harmonizing weights to the end.

`id_uniqid`, `id_survey`, `filename` must be present in all `.rds` files. 
